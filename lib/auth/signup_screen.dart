...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _handleSignup(BuildContext context) async {
    ...
    try {
      await context.read<AuthService>().signup(email.text.trim(), password.text.trim(), displayname.text.trim());
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Email Label
                const Text("Full Name", style: TextStyle(fontSize: 14, color: Color(0xFF9FB3C8))),
